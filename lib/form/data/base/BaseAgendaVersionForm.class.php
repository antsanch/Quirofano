...
/**
 * AgendaVersion form base class.
 *
 * @method AgendaVersion getObject() Returns the current form's model object
 *
 * @package    Quirofano
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseAgendaVersionForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('agenda_version[%s]');
