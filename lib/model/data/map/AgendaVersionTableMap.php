...
/**
 * This class defines the structure of the 'hc_agenda_version' table.
 *
 *
 ...
 */
class AgendaVersionTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lib.model.data.map.AgendaVersionTableMap';
    ...
    {
        // attributes
        $this->setName('hc_agenda_version');
        $this->setPhpName('AgendaVersion');
        $this->setClassname('AgendaVersion');
        $this->setPackage('lib.model.data');
        $this->setUseIdGenerator(false);
        // columns
        $this->addForeignPrimaryKey('ID', 'Id', 'INTEGER' , 'hc_agenda', 'ID', true, null, null);
        $this->addColumn('PROGRAMACION', 'Programacion', 'TIMESTAMP', false, null, null);
        $this->addColumn('HORA', 'Hora', 'TIME', false, null, null);
        $this->addColumn('RETRASO_INICIAL', 'RetrasoInicial', 'VARCHAR', false, 32, null);
        $this->addColumn('TIEMPO_TOTAL', 'TiempoTotal', 'VARCHAR', false, 32, null);
        ...
        $this->addColumn('SUMARY', 'Sumary', 'LONGVARCHAR', false, null, null);
    ...
    {
        $this->addRelation('Agenda', 'Agenda', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
