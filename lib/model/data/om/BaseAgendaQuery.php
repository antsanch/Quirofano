 ...
 * @method AgendaQuery orderByRetrasoInicial($order = Criteria::ASC) Order by the retraso_inicial column
 * @method AgendaQuery orderByTiempoTotal($order = Criteria::ASC) Order by the tiempo_total column
 ...
 * @method AgendaQuery orderBySumary($order = Criteria::ASC) Order by the sumary column
 ...
 * @method AgendaQuery orderByVersion($order = Criteria::ASC) Order by the version column
 *
 ...
 * @method AgendaQuery groupByRetrasoInicial() Group by the retraso_inicial column
 * @method AgendaQuery groupByTiempoTotal() Group by the tiempo_total column
 ...
 * @method AgendaQuery groupBySumary() Group by the sumary column
 ...
 * @method AgendaQuery groupByVersion() Group by the version column
 *
 ...
 *
 * @method AgendaQuery leftJoinAgendaVersion($relationAlias = null) Adds a LEFT JOIN clause to the query using the AgendaVersion relation
 * @method AgendaQuery rightJoinAgendaVersion($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AgendaVersion relation
 * @method AgendaQuery innerJoinAgendaVersion($relationAlias = null) Adds a INNER JOIN clause to the query using the AgendaVersion relation
 *
 ...
 * @method Agenda findOneByRetrasoInicial(string $retraso_inicial) Return the first Agenda filtered by the retraso_inicial column
 * @method Agenda findOneByTiempoTotal(string $tiempo_total) Return the first Agenda filtered by the tiempo_total column
 ...
 * @method Agenda findOneBySumary(string $sumary) Return the first Agenda filtered by the sumary column
 ...
 * @method Agenda findOneByVersion(int $version) Return the first Agenda filtered by the version column
 *
 ...
 * @method array findByRetrasoInicial(string $retraso_inicial) Return Agenda objects filtered by the retraso_inicial column
 * @method array findByTiempoTotal(string $tiempo_total) Return Agenda objects filtered by the tiempo_total column
 ...
 * @method array findBySumary(string $sumary) Return Agenda objects filtered by the sumary column
 ...
 * @method array findByVersion(int $version) Return Agenda objects filtered by the version column
 *
...
abstract class BaseAgendaQuery extends ModelCriteria
{
    ...
    public function filterByRetrasoInicial($retrasoInicial = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AgendaPeer::RETRASO_INICIAL, $retrasoInicial, $comparison);
    }
    ...
    public function filterByTiempoTotal($tiempoTotal = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AgendaPeer::TIEMPO_TOTAL, $tiempoTotal, $comparison);
    }
    ...
    public function filterBySumary($sumary = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AgendaPeer::SUMARY, $sumary, $comparison);
    }
    ...
    public function filterByVersion($version = null, $comparison = null)
    {
        if (is_array($version)) {
            ...
            if (isset($version['min'])) {
                $this->addUsingAlias(AgendaPeer::VERSION, $version['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($version['max'])) {
                $this->addUsingAlias(AgendaPeer::VERSION, $version['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AgendaPeer::VERSION, $version, $comparison);
    }
    ...
    /**
     * Filter the query by a related AgendaVersion object
     *
     * @param   AgendaVersion|PropelObjectCollection $agendaVersion  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return   AgendaQuery The current query, for fluid interface
     * @throws   PropelException - if the provided filter is invalid.
     */
    public function filterByAgendaVersion($agendaVersion, $comparison = null)
    {
        if ($agendaVersion instanceof AgendaVersion) {
            return $this
                ->addUsingAlias(AgendaPeer::ID, $agendaVersion->getId(), $comparison);
        } elseif ($agendaVersion instanceof PropelObjectCollection) {
            return $this
                ->useAgendaVersionQuery()
                ->filterByPrimaryKeys($agendaVersion->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByAgendaVersion() only accepts arguments of type AgendaVersion or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the AgendaVersion relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return AgendaQuery The current query, for fluid interface
     */
    public function joinAgendaVersion($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('AgendaVersion');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'AgendaVersion');
        }
    ...
    /**
     * Use the AgendaVersion relation AgendaVersion object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   AgendaVersionQuery A secondary query class using the current class as primary query
     */
    public function useAgendaVersionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinAgendaVersion($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'AgendaVersion', 'AgendaVersionQuery');
    }
