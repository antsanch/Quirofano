 ...
 * @method PersonalcirugiaQuery orderByEspecialidadId($order = Criteria::ASC) Order by the especialidad_id column
 ...
 * @method PersonalcirugiaQuery groupByEspecialidadId() Group by the especialidad_id column
 ...
 *
 * @method PersonalcirugiaQuery leftJoinEspecialidad($relationAlias = null) Adds a LEFT JOIN clause to the query using the Especialidad relation
 * @method PersonalcirugiaQuery rightJoinEspecialidad($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Especialidad relation
 * @method PersonalcirugiaQuery innerJoinEspecialidad($relationAlias = null) Adds a INNER JOIN clause to the query using the Especialidad relation
 *
 ...
 * @method Personalcirugia findOneByEspecialidadId(int $especialidad_id) Return the first Personalcirugia filtered by the especialidad_id column
 ...
 * @method array findByEspecialidadId(int $especialidad_id) Return Personalcirugia objects filtered by the especialidad_id column
...
abstract class BasePersonalcirugiaQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID`, `PERSONAL_ID`, `AGENDA_ID`, `PERSONAL_NOMBRE`, `ESPECIALIDAD_ID`, `TIPO`, `STATUS`, `PROGRAMA`, `INICIA`, `TRANSOPERATORIO`, `FINALIZA`, `TURNO`, `CREATED_AT` FROM `hc_agenda_personal` WHERE `ID` = :p0';
        try {
    ...
    public function filterByEspecialidadId($especialidadId = null, $comparison = null)
    {
        if (is_array($especialidadId)) {
            ...
            if (isset($especialidadId['min'])) {
                $this->addUsingAlias(PersonalcirugiaPeer::ESPECIALIDAD_ID, $especialidadId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($especialidadId['max'])) {
                $this->addUsingAlias(PersonalcirugiaPeer::ESPECIALIDAD_ID, $especialidadId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PersonalcirugiaPeer::ESPECIALIDAD_ID, $especialidadId, $comparison);
    }
    ...
    public function filterByEspecialidad($especialidad, $comparison = null)
    {
        if ($especialidad instanceof Especialidad) {
            return $this
                ->addUsingAlias(PersonalcirugiaPeer::ESPECIALIDAD_ID, $especialidad->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PersonalcirugiaPeer::ESPECIALIDAD_ID, $especialidad->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
