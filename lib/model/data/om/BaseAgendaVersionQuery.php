 ...
 * @method AgendaVersionQuery orderByFechaestado($order = Criteria::ASC) Order by the fechaestado column
 ...
 * @method AgendaVersionQuery orderByHoraestado($order = Criteria::ASC) Order by the horaestado column
 ...
 * @method AgendaVersionQuery groupByFechaestado() Group by the fechaestado column
 ...
 * @method AgendaVersionQuery groupByHoraestado() Group by the horaestado column
 ...
 * @method AgendaVersion findOneByFechaestado(string $fechaestado) Return the first AgendaVersion filtered by the fechaestado column
 ...
 * @method AgendaVersion findOneByHoraestado(string $horaestado) Return the first AgendaVersion filtered by the horaestado column
 ...
 * @method array findByFechaestado(string $fechaestado) Return AgendaVersion objects filtered by the fechaestado column
 ...
 * @method array findByHoraestado(string $horaestado) Return AgendaVersion objects filtered by the horaestado column
    ...
    public function filterByFechaestado($fechaestado = null, $comparison = null)
    {
        if (is_array($fechaestado)) {
            ...
            if (isset($fechaestado['min'])) {
                $this->addUsingAlias(AgendaVersionPeer::FECHAESTADO, $fechaestado['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($fechaestado['max'])) {
                $this->addUsingAlias(AgendaVersionPeer::FECHAESTADO, $fechaestado['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AgendaVersionPeer::FECHAESTADO, $fechaestado, $comparison);
    }
    ...
    public function filterByHoraestado($horaestado = null, $comparison = null)
    {
        if (is_array($horaestado)) {
            ...
            if (isset($horaestado['min'])) {
                $this->addUsingAlias(AgendaVersionPeer::HORAESTADO, $horaestado['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($horaestado['max'])) {
                $this->addUsingAlias(AgendaVersionPeer::HORAESTADO, $horaestado['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AgendaVersionPeer::HORAESTADO, $horaestado, $comparison);
    }
