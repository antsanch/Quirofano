...
abstract class BaseAgenda extends BaseObject implements Persistent
{
    ...
    /**
     * @var        PropelObjectCollection|AgendaVersion[] Collection to store aggregation of AgendaVersion objects.
     */
    protected $collAgendaVersions;
    protected $collAgendaVersionsPartial;
     ...
     * @var		PropelObjectCollection
     */
    protected $agendaVersionsScheduledForDeletion = null;
    ...
    public function setRetrasoInicial($v)
    {
        ...
        if ($this->retraso_inicial !== $v) {
            ...
            $this->modifiedColumns[] = AgendaPeer::RETRASO_INICIAL;
        }
    ...
    public function setTiempoTotal($v)
    {
        ...
        if ($this->tiempo_total !== $v) {
            $this->tiempo_total = $v;
            $this->modifiedColumns[] = AgendaPeer::TIEMPO_TOTAL;
        }
    ...
    public function setSumary($v)
    {
        ...
        if ($this->sumary !== $v) {
            $this->sumary = $v;
            $this->modifiedColumns[] = AgendaPeer::SUMARY;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[] = AgendaPeer::VERSION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 66; // 66 = AgendaPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->agendaVersionsScheduledForDeletion !== null) {
                if (!$this->agendaVersionsScheduledForDeletion->isEmpty()) {
                    AgendaVersionQuery::create()
                        ->filterByPrimaryKeys($this->agendaVersionsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->agendaVersionsScheduledForDeletion = null;
                }
            }

            if ($this->collAgendaVersions !== null) {
                foreach ($this->collAgendaVersions as $referrerFK) {
                    if (!$referrerFK->isDeleted()) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AgendaPeer::RETRASO_INICIAL)) {
            $modifiedColumns[':p' . $index++]  = '`RETRASO_INICIAL`';
        }
        if ($this->isColumnModified(AgendaPeer::TIEMPO_TOTAL)) {
        ...
        if ($this->isColumnModified(AgendaPeer::SUMARY)) {
        ...
        if ($this->isColumnModified(AgendaPeer::VERSION)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collAgendaVersions) {
                $result['AgendaVersions'] = $this->collAgendaVersions->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AgendaPeer::RETRASO_INICIAL)) $criteria->add(AgendaPeer::RETRASO_INICIAL, $this->retraso_inicial);
        if ($this->isColumnModified(AgendaPeer::TIEMPO_TOTAL)) $criteria->add(AgendaPeer::TIEMPO_TOTAL, $this->tiempo_total);
        ...
        if ($this->isColumnModified(AgendaPeer::SUMARY)) $criteria->add(AgendaPeer::SUMARY, $this->sumary);
        ...
        if ($this->isColumnModified(AgendaPeer::VERSION)) $criteria->add(AgendaPeer::VERSION, $this->version);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getAgendaVersions() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addAgendaVersion($relObj->copy($deepCopy));
                }
            }
    ...
    public function initRelation($relationName)
    {
        ...
        if ('AgendaVersion' == $relationName) {
            $this->initAgendaVersions();
        }
    }
     ...
     * @return PropelObjectCollection|Personalcirugia[] List of Personalcirugia objects
     */
    public function getPersonalcirugiasJoinEspecialidad($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PersonalcirugiaQuery::create(null, $criteria);
    ...
    /**
     * Clears out the collAgendaVersions collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return void
     * @see        addAgendaVersions()
     */
    public function clearAgendaVersions()
    {
        $this->collAgendaVersions = null; // important to set this to null since that means it is uninitialized
        $this->collAgendaVersionsPartial = null;
    }

    /**
     * reset is the collAgendaVersions collection loaded partially
     *
     * @return void
     */
    public function resetPartialAgendaVersions($v = true)
    {
        $this->collAgendaVersionsPartial = $v;
    }

    /**
     * Initializes the collAgendaVersions collection.
     *
     * By default this just sets the collAgendaVersions collection to an empty array (like clearcollAgendaVersions());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param boolean $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initAgendaVersions($overrideExisting = true)
    {
        if (null !== $this->collAgendaVersions && !$overrideExisting) {
            return;
        }
        $this->collAgendaVersions = new PropelObjectCollection();
        $this->collAgendaVersions->setModel('AgendaVersion');
    }

    /**
     * Gets an array of AgendaVersion objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|AgendaVersion[] List of AgendaVersion objects
     * @throws PropelException
     */
    public function getAgendaVersions($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collAgendaVersionsPartial && !$this->isNew();
        if (null === $this->collAgendaVersions || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collAgendaVersions) {
                // return empty collection
                $this->initAgendaVersions();
            } else {
                $collAgendaVersions = AgendaVersionQuery::create(null, $criteria)
                    ->filterByAgenda($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collAgendaVersionsPartial && count($collAgendaVersions)) {
                      $this->initAgendaVersions(false);

                      foreach($collAgendaVersions as $obj) {
                        if (false == $this->collAgendaVersions->contains($obj)) {
                          $this->collAgendaVersions->append($obj);
                        }
                      }

                      $this->collAgendaVersionsPartial = true;
                    }

                    return $collAgendaVersions;
                }

                if($partial && $this->collAgendaVersions) {
                    foreach($this->collAgendaVersions as $obj) {
                        if($obj->isNew()) {
                            $collAgendaVersions[] = $obj;
                        }
                    }
                }

                $this->collAgendaVersions = $collAgendaVersions;
                $this->collAgendaVersionsPartial = false;
            }
        }

        return $this->collAgendaVersions;
    }

    /**
     * Sets a collection of AgendaVersion objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $agendaVersions A Propel collection.
     * @param PropelPDO $con Optional connection object
     */
    public function setAgendaVersions(PropelCollection $agendaVersions, PropelPDO $con = null)
    {
        $this->agendaVersionsScheduledForDeletion = $this->getAgendaVersions(new Criteria(), $con)->diff($agendaVersions);

        foreach ($this->agendaVersionsScheduledForDeletion as $agendaVersionRemoved) {
            $agendaVersionRemoved->setAgenda(null);
        }

        $this->collAgendaVersions = null;
        foreach ($agendaVersions as $agendaVersion) {
            $this->addAgendaVersion($agendaVersion);
        }

        $this->collAgendaVersions = $agendaVersions;
        $this->collAgendaVersionsPartial = false;
    }

    /**
     * Returns the number of related AgendaVersion objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related AgendaVersion objects.
     * @throws PropelException
     */
    public function countAgendaVersions(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collAgendaVersionsPartial && !$this->isNew();
        if (null === $this->collAgendaVersions || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collAgendaVersions) {
                ...
                if($partial && !$criteria) {
                    return count($this->getAgendaVersions());
                }
                $query = AgendaVersionQuery::create(null, $criteria);
                if ($distinct) {
                    $query->distinct();
                }
            ...
            return count($this->collAgendaVersions);
        }
    }

    /**
     * Method called to associate a AgendaVersion object to this object
     * through the AgendaVersion foreign key attribute.
     *
     * @param    AgendaVersion $l AgendaVersion
     * @return Agenda The current object (for fluent API support)
     */
    public function addAgendaVersion(AgendaVersion $l)
    {
        if ($this->collAgendaVersions === null) {
            $this->initAgendaVersions();
            $this->collAgendaVersionsPartial = true;
        }
        if (!$this->collAgendaVersions->contains($l)) { // only add it if the **same** object is not already associated
            $this->doAddAgendaVersion($l);
        }
    ...
    /**
     * @param	AgendaVersion $agendaVersion The agendaVersion object to add.
     */
    protected function doAddAgendaVersion($agendaVersion)
    {
        $this->collAgendaVersions[]= $agendaVersion;
        $agendaVersion->setAgenda($this);
    }

    /**
     * @param	AgendaVersion $agendaVersion The agendaVersion object to remove.
     */
    public function removeAgendaVersion($agendaVersion)
    {
        if ($this->getAgendaVersions()->contains($agendaVersion)) {
            $this->collAgendaVersions->remove($this->collAgendaVersions->search($agendaVersion));
            if (null === $this->agendaVersionsScheduledForDeletion) {
                $this->agendaVersionsScheduledForDeletion = clone $this->collAgendaVersions;
                $this->agendaVersionsScheduledForDeletion->clear();
            }
            $this->agendaVersionsScheduledForDeletion[]= $agendaVersion;
            $agendaVersion->setAgenda(null);
        }
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep) {
            ...
            if ($this->collAgendaVersions) {
                foreach ($this->collAgendaVersions as $o) {
                    $o->clearAllReferences($deep);
                }
            }
        } // if ($deep)
        ...
        $this->collProcedimientregrogramados = null;
        if ($this->collAgendaVersions instanceof PropelCollection) {
            $this->collAgendaVersions->clearIterator();
        }
        $this->collAgendaVersions = null;
        $this->aSalaquirurgica = null;
        $this->aQuirofano = null;
    ...
    public function isVersioningNecessary($con = null)
    {
        ...
        if (AgendaPeer::isVersioningEnabled() && ($this->isNew() || $this->isModified() || $this->isDeleted())) {
            return true;
        }
     ...
     *
     * @return  AgendaVersion A version object
     */
    public function addVersion($con = null)
    {
        $this->enforceVersion = false;

        $version = new AgendaVersion();
        $version->setId($this->getId());
        $version->setProgramacion($this->getProgramacion());
        $version->setFechaestado($this->getFechaestado());
        $version->setHora($this->getHora());
        $version->setRetrasoInicial($this->getRetrasoInicial());
        $version->setTiempoTotal($this->getTiempoTotal());
        $version->setHoraestado($this->getHoraestado());
        $version->setInicio($this->getInicio());
        $version->setLastTime($this->getLastTime());
        $version->setIngreso($this->getIngreso());
        $version->setSalaId($this->getSalaId());
        $version->setQuirofanoId($this->getQuirofanoId());
        $version->setEgreso($this->getEgreso());
        $version->setCie9mc($this->getCie9mc());
        $version->setCie9mcId($this->getCie9mcId());
        $version->setCxRealizada($this->getCxRealizada());
        $version->setCxRealizadaId($this->getCxRealizadaId());
        $version->setTipoCx($this->getTipoCx());
        $version->setDiagnostico($this->getDiagnostico());
        $version->setDiagnosticoId($this->getDiagnosticoId());
        $version->setMedicoName($this->getMedicoName());
        $version->setPacienteName($this->getPacienteName());
        $version->setPacienteId($this->getPacienteId());
        $version->setEdad($this->getEdad());
        $version->setGenero($this->getGenero());
        $version->setGeneroId($this->getGeneroId());
        $version->setRegistro($this->getRegistro());
        $version->setServicio($this->getServicio());
        $version->setAnestesiaId($this->getAnestesiaId());
        $version->setAnestesiaEmpleada($this->getAnestesiaEmpleada());
        $version->setEvAdversosAnestesia($this->getEvAdversosAnestesia());
        $version->setObservaciones($this->getObservaciones());
        $version->setRequerimiento($this->getRequerimiento());
        $version->setReqInsumos($this->getReqInsumos());
        $version->setReqHemoderiv($this->getReqHemoderiv());
        $version->setReqLaboratorio($this->getReqLaboratorio());
        $version->setReqAnestesico($this->getReqAnestesico());
        $version->setStatus($this->getStatus());
        $version->setCausaDiferidoId($this->getCausaDiferidoId());
        $version->setSolicitado($this->getSolicitado());
        $version->setRiesgoqxId($this->getRiesgoqxId());
        $version->setContaminacionqxId($this->getContaminacionqxId());
        $version->setEventoqxId($this->getEventoqxId());
        $version->setComplicaciones($this->getComplicaciones());
        $version->setValPreAnestesica($this->getValPreAnestesica());
        $version->setReintervencion($this->getReintervencion());
        $version->setPermisos($this->getPermisos());
        $version->setTipoProcId($this->getTipoProcId());
        $version->setAtencionId($this->getAtencionId());
        $version->setTiempoFuera($this->getTiempoFuera());
        $version->setProcedencia($this->getProcedencia());
        $version->setClasificacionqx($this->getClasificacionqx());
        $version->setRegionPx($this->getRegionPx());
        $version->setExtensionPx($this->getExtensionPx());
        $version->setAnexoDetalle($this->getAnexoDetalle());
        $version->setDestinoPx($this->getDestinoPx());
        $version->setLiberacionSala($this->getLiberacionSala());
        $version->setTiempoEst($this->getTiempoEst());
        $version->setRiesgoQxPre($this->getRiesgoQxPre());
        $version->setShowInIndex($this->getShowInIndex());
        $version->setProtocolo($this->getProtocolo());
        $version->setCancelada($this->getCancelada());
        $version->setSumary($this->getSumary());
        $version->setCreatedAt($this->getCreatedAt());
        $version->setUpdatedAt($this->getUpdatedAt());
        $version->setVersion($this->getVersion());
        $version->setAgenda($this);
        $version->save($con);
    ...
    public function toVersion($versionNumber, $con = null)
    {
        ...
        if (!$version) {
            throw new PropelException(sprintf('No Agenda object found with version %d', $version));
        }
     ...
     * Sets the properties of the curent object to the value they had at a specific version
     *
     * @param   AgendaVersion $version The version object to use
     * @param   PropelPDO $con the connection to use
    ...
    public function populateFromVersion($version, $con = null, &$loadedObjects = array())
    {
        ...
        $loadedObjects['Agenda'][$version->getId()][$version->getVersion()] = $this;
        $this->setId($version->getId());
        $this->setProgramacion($version->getProgramacion());
        $this->setFechaestado($version->getFechaestado());
        $this->setHora($version->getHora());
        $this->setRetrasoInicial($version->getRetrasoInicial());
        $this->setTiempoTotal($version->getTiempoTotal());
        $this->setHoraestado($version->getHoraestado());
        $this->setInicio($version->getInicio());
        $this->setLastTime($version->getLastTime());
        $this->setIngreso($version->getIngreso());
        $this->setSalaId($version->getSalaId());
        $this->setQuirofanoId($version->getQuirofanoId());
        $this->setEgreso($version->getEgreso());
        $this->setCie9mc($version->getCie9mc());
        $this->setCie9mcId($version->getCie9mcId());
        $this->setCxRealizada($version->getCxRealizada());
        $this->setCxRealizadaId($version->getCxRealizadaId());
        $this->setTipoCx($version->getTipoCx());
        $this->setDiagnostico($version->getDiagnostico());
        $this->setDiagnosticoId($version->getDiagnosticoId());
        $this->setMedicoName($version->getMedicoName());
        $this->setPacienteName($version->getPacienteName());
        $this->setPacienteId($version->getPacienteId());
        $this->setEdad($version->getEdad());
        $this->setGenero($version->getGenero());
        $this->setGeneroId($version->getGeneroId());
        $this->setRegistro($version->getRegistro());
        $this->setServicio($version->getServicio());
        $this->setAnestesiaId($version->getAnestesiaId());
        $this->setAnestesiaEmpleada($version->getAnestesiaEmpleada());
        $this->setEvAdversosAnestesia($version->getEvAdversosAnestesia());
        $this->setObservaciones($version->getObservaciones());
        $this->setRequerimiento($version->getRequerimiento());
        $this->setReqInsumos($version->getReqInsumos());
        $this->setReqHemoderiv($version->getReqHemoderiv());
        $this->setReqLaboratorio($version->getReqLaboratorio());
        $this->setReqAnestesico($version->getReqAnestesico());
        $this->setStatus($version->getStatus());
        $this->setCausaDiferidoId($version->getCausaDiferidoId());
        $this->setSolicitado($version->getSolicitado());
        $this->setRiesgoqxId($version->getRiesgoqxId());
        $this->setContaminacionqxId($version->getContaminacionqxId());
        $this->setEventoqxId($version->getEventoqxId());
        $this->setComplicaciones($version->getComplicaciones());
        $this->setValPreAnestesica($version->getValPreAnestesica());
        $this->setReintervencion($version->getReintervencion());
        $this->setPermisos($version->getPermisos());
        $this->setTipoProcId($version->getTipoProcId());
        $this->setAtencionId($version->getAtencionId());
        $this->setTiempoFuera($version->getTiempoFuera());
        $this->setProcedencia($version->getProcedencia());
        $this->setClasificacionqx($version->getClasificacionqx());
        $this->setRegionPx($version->getRegionPx());
        $this->setExtensionPx($version->getExtensionPx());
        $this->setAnexoDetalle($version->getAnexoDetalle());
        $this->setDestinoPx($version->getDestinoPx());
        $this->setLiberacionSala($version->getLiberacionSala());
        $this->setTiempoEst($version->getTiempoEst());
        $this->setRiesgoQxPre($version->getRiesgoQxPre());
        $this->setShowInIndex($version->getShowInIndex());
        $this->setProtocolo($version->getProtocolo());
        $this->setCancelada($version->getCancelada());
        $this->setSumary($version->getSumary());
    ...
    {
        return AgendaVersionQuery::create()
            ->filterByAgenda($this)
     ...
     * @param   PropelPDO $con the connection to use
     *
     * @return  PropelObjectCollection A list of AgendaVersion objects
     */
    public function getAllVersions($con = null)
    {
        $criteria = new Criteria();
        $criteria->addAscendingOrderByColumn(AgendaVersionPeer::VERSION);

        return $this->getAgendaVersions($criteria, $con);
    }
     ...
     * @param AgendaVersionQuery|Criteria $criteria Additional criteria to filter.
     * @param PropelPDO $con An optional connection to use.
     *
     * @return PropelCollection|AgendaVersion[] List of AgendaVersion objects
     */
    public function getLastVersions($number = 10, $criteria = null, PropelPDO $con = null)
    {
        $criteria = AgendaVersionQuery::create(null, $criteria);
        $criteria->addDescendingOrderByColumn(AgendaVersionPeer::VERSION);
