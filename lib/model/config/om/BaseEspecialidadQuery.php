 ...
 *
 * @method EspecialidadQuery leftJoinPersonalcirugia($relationAlias = null) Adds a LEFT JOIN clause to the query using the Personalcirugia relation
 * @method EspecialidadQuery rightJoinPersonalcirugia($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Personalcirugia relation
 * @method EspecialidadQuery innerJoinPersonalcirugia($relationAlias = null) Adds a INNER JOIN clause to the query using the Personalcirugia relation
 *
...
abstract class BaseEspecialidadQuery extends ModelCriteria
{
    ...
    public function filterByPersonalcirugia($personalcirugia, $comparison = null)
    {
        if ($personalcirugia instanceof Personalcirugia) {
            return $this
                ->addUsingAlias(EspecialidadPeer::ID, $personalcirugia->getEspecialidadId(), $comparison);
